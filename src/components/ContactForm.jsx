        ...
        <div className="flex flex-wrap lg:justify-between -mx-4">
          <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div className="max-w-[570px] mb-12 lg:mb-0">
              ...
              Si estás interesado en colaborar en un emocionante proyecto o tienes alguna pregunta, ¡me encantaría saber de ti! Puedes contactarme directamente a través del formulario de contacto aquí mismo en mi portfolio. Además, puedes conectarte conmigo en LinkedIn para mantenernos en contacto y estar al tanto de mis últimas actualizaciones profesionales. Si deseas explorar mis proyectos y contribuciones en código abierto, también puedes visitar mi perfil en GitHub. Espero con interés la oportunidad de colaborar y compartir ideas en el emocionante mundo del desarrollo web.
              </p>
